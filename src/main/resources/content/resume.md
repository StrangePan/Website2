...
and strives for excellence in engineering and user experience. Has experience
working on both small teams and enormous projects with hundreds of concurrent
contributors, and with dozens of integrated technologies both proprietary and
industry-standard.

# <i class="fa fa-suitcase" aria-hidden="true"></i> Career

## Factorio <span class="subtitle">2021-present</span>

Programmer and partial game designer on [Factorio<i class="fa-solid fa-up-right-from-square"></i>](https://factorio.com). Worked
on several features, engine enhancements, and content for the base game and the
Space Age expansion. Responsible for Mac support, UI enhancements, enemy gameplay
design and AI implementation, and several other miscellaneous features along the way.

## YouTube <span class="subtitle">2016-2021</span>
